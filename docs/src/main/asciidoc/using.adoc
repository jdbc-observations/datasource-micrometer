...
== Span Lifecycle with Datasource Micrometer's API

Datasource Micrometer Core in its `api` module contains all necessary interfaces to be implemented by a tracer.
...
TIP: Datasource Micrometer creates an instance of `Tracer` for you.
