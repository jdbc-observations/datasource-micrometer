...
This allows Spring Cloud’s refresh mechanism to unwrap the proxy and access the underlying `HikariDataSource`.

The `SPRING_PROXY` option is available since datasource-micrometer versions 1.4 and 2.2.
