...
Observation orders without OIV/OSIV:

. Start HTTP request observation
. Start DB connection observation
. (Other observations)
. Stop DB connection observation
. Stop HTTP request observation
...
. Start DB connection observation
. (Other observations)
. *(SWAPPED)* Stop HTTP request observation
. *(SWAPPED)* Stop DB connection observation
