...
[[how-to-fix-existingvalue-hikaridatasource-error]]
=== How to Fix “ExistingValue must be an instance of com.zaxxer.hikari.HikariDataSource” Error

If you encounter this error when using Spring Cloud refresh, see <<using-features-hikaricp-support-spring-cloud-refresh>> for details and the recommended configuration.
