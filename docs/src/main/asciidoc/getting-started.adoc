...
Datasource Micrometer borrows https://research.google.com/pubs/pub36356.html[Dapper's] terminology.
...
== Developing Your First Datasource Micrometer-based Application

This section describes how to develop a small “Hello World!” web application that highlights some of Datasource Micrometer’s key features.
...
[TIP]
====
You can shortcut the steps below by going to https://start.spring.io and choosing the "Web" and "Datasource Micrometer" starters from the dependencies searcher.
...
----
	...
	<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<!-- Datasource Micrometer requires a Spring Cloud BOM -->
...
Datasource Micrometer with Brave tracer will provide instrumentation of the incoming request.
